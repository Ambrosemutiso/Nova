        ...
        >
          <div className="bg-gradient-to-br from-[#1c1c1e] to-[#111213] px-6 pt-10 pb-8 relative">
            ...
            <p className="text-gray-400 text-sm mt-2 leading-relaxed">
              Your feedback helps us build a better shopping experience for everyone.
            </p>
          </div>
...
/* ════════════════════════════════════════════════════════════════
   FAKE REVIEWS DATA — buyer/customer voice
════════════════════════════════════════════════════════════════ */
const REVIEWS = [
  {
    name: 'Mercy Wambui',
    ...
    avatar: 'MW',
    rating: 5,
    text: 'I ordered a blender and it arrived the very same day. The packaging was solid and customer support replied to my question within minutes. Genuinely impressed.',
    time: '1 day ago',
  },
  {
    name: 'Daniel Kiprotich',
    role: 'Verified Buyer · Eldoret',
    avatar: 'DK',
    rating: 5,
    text: 'The installment plan made it possible for me to finally get a laptop for work. Payments were smooth and I always knew exactly how much was left.',
    time: '4 days ago',
  },
  {
    name: 'Faith Achieng',
    ...
    avatar: 'FA',
    rating: 4,
    text: 'Great selection of products and fair prices. Delivery to Kisumu took a couple of days longer than expected, but the item was exactly as described.',
    time: '6 days ago',
  },
  {
    name: 'Peter Maina',
    role: 'Verified Buyer · Thika',
    avatar: 'PM',
    rating: 5,
    text: 'Tracking my order was so easy with the barcode and live status updates. I always felt informed about where my package was. Will shop here again.',
    time: '1 week ago',
  },
  {
    name: 'Lucy Nyambura',
    ...
    avatar: 'LN',
    rating: 5,
    text: 'I was nervous about buying electronics online but the buyer protection gave me confidence. Everything arrived perfectly and on time.',
    time: '2 weeks ago',
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-8 items-start">
          ...
          <div className="order-2 lg:order-1">
            <div className="mb-5 flex items-center justify-between">
              <div>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">What customers are saying</p>
                <h2 className="text-xl font-black text-gray-800">Customer Reviews</h2>
              </div>
              {/* avg rating callout */}
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-4 py-3 text-center">
                <p className="text-3xl font-black text-orange-500 leading-none">4.8</p>
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              {[
                ...
                { label: 'Satisfaction',    value: '96%',       sub: 'Of buyers rate us 4★+' },
                { label: 'Orders Delivered',value: '50K+',       sub: 'Across Kenya' },
              ].map((stat, i) => (
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="px-6 py-6 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input name="name" required placeholder="e.g. Mercy Wambui" className={inputCls} />
                </div>
                <div>
