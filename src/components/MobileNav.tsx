  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {/* shadow pooled at the base of the notch — slightly heavier in
            dark mode since it needs to read against a dark bar too */}
        <div
          className="pointer-events-none absolute left-1/2 -translate-x-1/2 rounded-full bg-black/15 dark:bg-black/40 blur-md"
          style={{ top: `${-FAB_LIFT + 14}px`, width: `${NOTCH_RADIUS * 1.6}px`, height: `${NOTCH_RADIUS * 0.9}px` }}
        />

        <div
          className="relative flex items-center justify-between w-full px-2 pt-3 rounded-t-3xl
            border-t border-gray-200 dark:border-white/10
            shadow-[0_-4px_24px_rgba(0,0,0,0.08)] dark:shadow-[0_-4px_24px_rgba(0,0,0,0.4)]
            backdrop-blur-md bg-white/95 dark:bg-neutral-900/95"
          style={{
        ...
        {/* FAB — the ring bridges the button into the notch, so it needs
            to match the bar's own background in each theme, not stay
            hardcoded white */}
        <Link
          href={fabHref}
        ...
        >
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 text-white p-3.5 rounded-full
            ring-4 ring-white dark:ring-neutral-900 shadow-lg shadow-orange-400/40 dark:shadow-orange-500/20
