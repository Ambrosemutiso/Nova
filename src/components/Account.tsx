...
export default function MyAccountPage({ onOpenBuyerLogin }: MyAccountPageProps) {
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-[420px] flex-col bg-[#f4f4f2] font-sans text-neutral-900">
      {/* header */}
      <div className="bg-[#f4f4f2] px-4 pb-4 pt-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-5 text-neutral-800">
            ...
            <button onClick={goTo("/")} aria-label="Scan">
        ...
        <button onClick={goTo("/")} className="mt-1.5 flex items-center gap-1.5 pl-[3.5rem] text-[14px] text-neutral-500">
